<?php 
	...
	class Kiwi{
		...
		function __construct($name_tpl){
			...
			/*< guarda una copia de la plantilla que tiene las variables de proyecto ya reemplazadas */
			$this->template_buffer = $this->buffer;
		}
		...
		private function load(){
			...
			$this->setVars(["PROJECT_NAME" => $_ENV['PROJECT_NAME'],
				...
				"PROJECT_CSS_ROUTE" => $_ENV['PROJECT_CSS_ROUTE'],
				"PROJECT_IMG_ROUTE" => $_ENV['PROJECT_IMG_ROUTE'],
				"PROJECT_JS_ROUTE" => $_ENV['PROJECT_JS_ROUTE'],
		 ...
		 * 
		 * */
		private function testVar($name_var){
			return strpos( $this->buffer, $name_var);
		}

		/**
		 * 
		 * Retorna el buffer, útil para plantillas que no se imprimen en pantalla
		 * @return string
		 * 
		 * */
		function getBuffer(){
		...
		function resetBuffer(){
			$this->buffer = $this->template_buffer;
		}
